...
export default function OrganizationDashboard() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-brand-charcoal">Organization Dashboard</h1>
        <p className="text-brand-muted">Monitor available food rescues and collect deliveries.</p>
      </div>
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-brand-sage/30">
                  {history.length > 0 ? history.map((item) => (
                    ...
                    <tr>
                      <td colSpan="4" className="py-8 text-center text-brand-muted">Your organization hasn't collected any donations yet.</td>
                    </tr>
                  )}
                </tbody>
              </table>
